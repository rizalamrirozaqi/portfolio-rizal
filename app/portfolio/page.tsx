...
const beritaKini = ["/assets/img/portfolio/web/berita-kini/berita-kini.mp4"];
...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen h-full w-full pt-10 lg:pt-28 px-6 sm:px-20 relative ">
      ...
      {renderImageSection("News Site", beritaKini, "At the end of my 4th semester, I completed a technical internship test by developing a news website using Next.js. The website fetches and displays real-time news articles from a public news API. This project helped me sharpen my skills in modern frontend development, API integration, and asynchronous data handling within the React/Next.js ecosystem.")}
